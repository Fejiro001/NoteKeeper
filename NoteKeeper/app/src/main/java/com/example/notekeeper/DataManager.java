...
//            ourInstance.initializeExampleNotes();
    ...
    //This method allows us to explicitly load the lists from the database
    public static void loadFromDatabase(NoteKeeperOpenHelper dbHelper) {
        //This line of code us to interact with the database
    ...
    //Method to use the notes cursor
    private static void loadNotesFromDatabase(Cursor cursor) {
        //First we get the positions of each column
        ...
        //We got an instance of the data manager singleton and cleared any data in the notes list
        DataManager dm = getInstance();
        dm.mNotes.clear();
        //Next we will go through each row and get the strings at the specified positions
        while (cursor.moveToNext()) {
            String noteTitle = cursor.getString(noteTitlePos);
            String noteText = cursor.getString(noteTextPos);
            String courseId = cursor.getString(courseIdPos);

            //Create a new instance of note info and add it to the notes list
    ...
    //Same as the loadFromNotesDatabase comments
